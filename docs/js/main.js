...
function handleWindowScroll() {
  _js_utils_lazy_loader__WEBPACK_IMPORTED_MODULE_0__["scanImages"](); // TODO: add code
}
/**
...
function initBlock() {
  ...
  _js_utils_lazy_loader__WEBPACK_IMPORTED_MODULE_0__["init"](); // TODO: initialize other blocks

  _blocks_header_header__WEBPACK_IMPORTED_MODULE_1__["default"].initBlock(); // Process the initial window size and scroll position
...
function initBlock() {
  ...
  $('.header__slick').slick({
    ...
    slidesToScroll: 1,
    // dotsClass: 'my-dots',
    nextArrow: $('.header__prevArrow'),
    prevArrow: $('.header__nextArrow')
  });
  return true;
} // ---------------------------- END PUBLIC METHODS ----------------------------
...
/*!*************************************!*\
  !*** ./src/js/utils/lazy-loader.js ***!
  \*************************************/
/*! exports provided: init, scanImages */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function loadImage($img) {
  ...
  }).removeAttr('data-src data-srcset').removeClass('lazy');
} // ------------------------------ END DOM METHODS -----------------------------
// --------------------------- BEGIN PUBLIC METHODS ---------------------------
...
module.exports = __webpack_require__(/*! H:\На работу\testWork\TechnicalRequirements\src\js\main.js */"./src/js/main.js");
